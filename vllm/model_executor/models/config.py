...
class NemotronHNanoVLV2Config(VerifyAndUpdateConfig):
    ...
    def verify_and_update_model_config(model_config: "ModelConfig") -> None:
        ...
        if not hasattr(vision_config, "args"):
            intermediate_size = int(vision_config.hidden_size * vision_config.mlp_ratio)
            signature = (
            ...
            if signature != (1280, 32, 16, 5120):
                raise ValueError(f"Unsupported RADIO architecture: {signature}")
            ...
            vision_config.preferred_resolution = (
